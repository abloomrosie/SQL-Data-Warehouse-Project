...
BEGIN
    ...
    end_time := NOW();
    RAISE NOTICE 'CRM Cust Info Rows: %', row_count;
    ...
    GET DIAGNOSTICS row_count = ROW_COUNT;
    end_time := NOW();
    RAISE NOTICE 'CRM Product Info Rows: %', row_count;
    RAISE NOTICE 'Duration: % sec', EXTRACT(EPOCH FROM(end_time - start_time));
    ...
    GET DIAGNOSTICS row_count = ROW_COUNT;
    end_time := NOW();
    RAISE NOTICE 'CRM Sales Details Rows: %', row_count;
    RAISE NOTICE 'Duration: % sec', EXTRACT(EPOCH FROM(end_time - start_time));
    ...
    GET DIAGNOSTICS row_count = ROW_COUNT;
    end_time := NOW();
    RAISE NOTICE 'ERP Cust AZ12 Rows: %', row_count;
    RAISE NOTICE 'Duration: % sec', EXTRACT(EPOCH FROM(end_time - start_time));
    ...
    GET DIAGNOSTICS row_count = ROW_COUNT;
    end_time := NOW();
    RAISE NOTICE 'ERP Loc A101 Rows: %', row_count;
    RAISE NOTICE 'Duration: % sec', EXTRACT(EPOCH FROM(end_time - start_time));
    ...
    GET DIAGNOSTICS row_count = ROW_COUNT;
    end_time := NOW();
    RAISE NOTICE 'ERP PX CAT G1V2 Rows: %', row_count;
    RAISE NOTICE 'Duration: % sec', EXTRACT(EPOCH FROM(end_time - start_time));
    ...
    RAISE NOTICE 'Total Duration: % sec', EXTRACT(EPOCH FROM(batch_end_time - batch_start_time));

EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE 'ERROR DURING SILVER LAYER LOAD: %', SQLERRM;
END;
$$;
